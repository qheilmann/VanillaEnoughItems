...
public class StonecuttingProcessPanel extends ProcessPanel<StonecuttingRecipe> {
    ...
    public static final ProcessPanelSlot INGREDIENT_SLOT = new ProcessPanelSlot(2, 2);
    public static final ProcessPanelSlot WORKBENCH_SLOT = new ProcessPanelSlot(3, 2);
    public static final ProcessPanelSlot RESULT_SLOT = new ProcessPanelSlot(5, 2);

    private static final Material WORKBENCH_DISPLAY_MATERIAL = Material.STONECUTTER;
    
    public StonecuttingProcessPanel(@NotNull Style style, @NotNull RecipeIndexService recipeIndex, @NotNull ProcessRecipeReader<StonecuttingRecipe> recipeReader) {
    ...
    public void render(EnumSet<AttachedButtonType> buttonsVisibility) {
        ...
        StonecuttingRecipe recipe = getCurrentRecipe();
