...
public class VeiButtonType implements ButtonType {
    public static class RecipeMenu {
        ...
        public static final ButtonType BOOKMARK_THIS_RECIPE_BOOKMARKED = new VeiButtonType("bookmark_this_recipe_bookmark");
        public static final ButtonType BOOKMARK_THIS_RECIPE_UNBOOKMARKED = new VeiButtonType("bookmark_this_recipe_unbookmark");
        public static final ButtonType BOOKMARK_THIS_RECIPE_UNABLE = new VeiButtonType("bookmark_this_recipe_unable");
