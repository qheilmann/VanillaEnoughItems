...
public class BlastingProcessPanel extends ProcessPanel<BlastingRecipe> {
    ...
    private static final Material WORKBENCH_DISPLAY_MATERIAL = Material.BLAST_FURNACE;
    
    public BlastingProcessPanel(@NotNull Style style, @NotNull RecipeIndexService recipeIndex, @NotNull ProcessRecipeReader<BlastingRecipe> recipeReader) {
    ...
    public void render(EnumSet<AttachedButtonType> buttonsVisibility) {
        ...
        BlastingRecipe recipe = getCurrentRecipe();
