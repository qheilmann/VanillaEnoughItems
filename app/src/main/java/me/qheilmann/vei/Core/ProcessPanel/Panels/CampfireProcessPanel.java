...
public class CampfireProcessPanel extends ProcessPanel<CampfireRecipe> {
    ...
    private static final Material WORKBENCH_DISPLAY_MATERIAL = Material.CAMPFIRE;
    
    public CampfireProcessPanel(@NotNull Style style, @NotNull RecipeIndexService recipeIndex, @NotNull ProcessRecipeReader<CampfireRecipe> recipeReader) {
