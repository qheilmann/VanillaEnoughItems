...
public enum ButtonType {
    ...
    // ButtonType(Component displayName, List<? extends Component> lores, String reference) {
    ...
    // public static ButtonType fromReference(String reference) {
    //     for (ButtonType buttonType : ButtonType.values()) {
    //         if (buttonType.getReference().equals(reference)) {
    //             return buttonType;
    //         }
    //     }
