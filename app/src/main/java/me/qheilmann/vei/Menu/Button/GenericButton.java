...
public abstract class GenericButton extends ButtonItem {
    ...
    protected Component displayName = Component.text("undefined_generic_button");
    protected List<? extends Component> lores = List.of(Component.text("undefined_generic_button"));
    ...
    protected GenericButton(@NotNull ItemStack skin, IMenu ownerMenu, MenuManager menuManager) {
